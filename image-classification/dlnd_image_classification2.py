...
import ipdb
import sys
sys.path.insert(1,'//anaconda/envs/tflearn/lib/python3.5/site-packages')
import matplotlib
...
# Inputs
# these functions give tf.placeholder with none as the first dimension
...
def train_neural_network(session, optimizer, keep_probability, feature_batch, label_batch):
    ...
    feed1 = {x:feature_batch, y:label_batch, keep_prob:keep_probability}
    session.run([cost, accuracy, optimizer], feed_dict = feed1)
...
def print_stats(session, feature_batch, label_batch, cost, accuracy):
    ...
    """
    feed1 = {x:valid_features, y:valid_batch, keep_prob:0}
    loss, accuracy = session.run([cost, accuracy],feed_dict=feed1)
    print('loss:{} accuracy:{}'.format(loss,accuracy))# TODO: Implement Function
